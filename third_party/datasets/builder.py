...
class DatasetBuilder:
    ...
    def _build_cache_dir(self):
        """Return the data directory for the current version. Update the cache directory if the code has changed."""
        name = self._cache_dir_root.split("/")[-2]
        return Path(self._cache_dir_root) / name
    ...
    def download_and_prepare(
        ...
        **download_and_prepare_kwargs,
        ...
        """
        # file_format = "parquet"
        # output_dir = "/datadrive1/updated_data/ZhiyingDu_Pi0_Dataset/calvin/data"
        output_dir = output_dir if output_dir is not None else self._cache_dir
        # print("self._cache_dir:", self._cache_dir)
        ...
        # print("output_dir3", self._output_dir)
        ...
        with FileLock(lock_path) if is_local else contextlib.nullcontext():
            ...
            data_exists =  os.path.exists(posixpath.join(self._output_dir, config.DATASET_INFO_FILENAME))
            if data_exists and download_mode == DownloadMode.REUSE_DATASET_IF_EXISTS:
                ...
                print("****************load cache from ", self._output_dir)
                return
