...
class DownloadManager:
    ...
    def _download_single(self, url_or_filename: str, download_config: DownloadConfig) -> str:
        ...
        # print("download_config:",download_config, "url_or_filename:", url_or_filename, "out:", out)
        out = tracked_str(out)
    ...
    def extract(self, path_or_paths):
        ...
        # print("download_config.num_proc:", download_config.num_proc)
        # first_key = list(path_or_paths.keys())[0]
        # value = path_or_paths[first_key]
        # import json
        # # 将值保存为 JSON 文件
        # with open('data_files_new1.json', 'w') as file:
        ...
        # first_key = list(extracted_paths.keys())[0]
        # value = extracted_paths[first_key]
        # import json
        # # 将值保存为 JSON 文件
        # with open('data_files_new2.json', 'w') as file:
        #     json.dump(value, file)
        # assert 0 == 1
        # print("extracted_paths:", extracted_paths)
