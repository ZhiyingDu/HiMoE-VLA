...
class AlohaInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # state = transforms.pad_state_to_dim(data["observation/state"], self.action_dim*2, self.data_mask)
        ...
        if "actions" in data:
            ...
            # inputs["actions"] = transforms.pad_to_dim(actions, self.action_dim, self.data_mask)
...
def _decode_aloha(data: dict, *, adapt_to_pi: bool = False) -> dict:
    ...
    if data.get("observation/image") is not None:
        data["observation/image"] = convert_image(data["observation/image"])
    if data.get("observation/wrist_image") is not None:
        data["observation/wrist_image"] = convert_image(data["observation/wrist_image"])
    if data.get("observation/wrist_image2") is not None:
        data["observation/wrist_image2"] = convert_image(data["observation/wrist_image2"])
